...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_myip_axi_v1_0_M_AXI is
  ...
  attribute SOFT_HLUTNM of \axi_awaddr[27]_i_4\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of axi_bready_i_1 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of axi_rready_i_2 : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of error_reg_i_3 : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \read_burst_counter[7]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \read_burst_counter[8]_i_1\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \write_burst_counter[10]_i_2\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \write_burst_counter[7]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \write_burst_counter[8]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \write_burst_counter[9]_i_1\ : label is "soft_lutpair1";
...
ERROR_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAFFFFFCAA000000"
    )
        port map (
      I0 => \^error_reg\,
      I1 => \axi_awaddr[27]_i_5_n_0\,
      I2 => axi_rready_i_2_n_0,
      I3 => mst_exec_state(0),
      I4 => compare_done,
      I5 => \^m_axi_error\,
      O => ERROR_i_1_n_0
...
\axi_awaddr[27]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"04FF"
    )
        port map (
...
\axi_awaddr[27]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
        ...
        port map (
      I0 => \axi_awaddr[27]_i_6_n_0\,
      I1 => counter_reg(11),
      O => \axi_awaddr[27]_i_4_n_0\
    );
\axi_awaddr[27]_i_5\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => counter_reg(4),
      I3 => counter_reg(3),
      I4 => \axi_awaddr[27]_i_7_n_0\,
      I5 => \axi_awaddr[27]_i_8_n_0\,
      O => \axi_awaddr[27]_i_5_n_0\
    );
\axi_awaddr[27]_i_6\: unisim.vcomponents.LUT6
    generic map(
...
\axi_awaddr[27]_i_7\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\axi_awaddr[27]_i_8\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
compare_done_i_2: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFBFF000000"
        ...
        port map (
      I0 => \axi_awaddr[27]_i_5_n_0\,
      I1 => counter_reg(9),
      I2 => \axi_awaddr[27]_i_4_n_0\,
      I3 => mst_exec_state(0),
      I4 => compare_done,
      I5 => \^m_axi_txn_done\,
