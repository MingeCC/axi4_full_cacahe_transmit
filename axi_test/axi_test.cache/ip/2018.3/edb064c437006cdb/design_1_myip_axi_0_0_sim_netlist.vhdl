...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_myip_axi_v1_0_M_AXI is
  ...
  signal \write_burst_counter[9]_i_3_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \read_burst_counter[6]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \read_burst_counter[7]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \read_burst_counter[8]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \read_burst_counter[9]_i_2\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \write_burst_counter[6]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \write_burst_counter[7]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \write_burst_counter[8]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \write_burst_counter[9]_i_2\ : label is "soft_lutpair4";
...
M_AXI_ARADDR_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(0) => '0',
      O(3 downto 0) => \^m_axi_araddr\(27 downto 24),
...
\read_burst_counter[6]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
        ...
        port map (
      I0 => \read_burst_counter[9]_i_3_n_0\,
...
\read_burst_counter[8]_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => \read_burst_counter[9]_i_3_n_0\,
      I2 => \read_burst_counter_reg_n_0_[7]\,
      I3 => \read_burst_counter_reg_n_0_[8]\,
      O => \p_0_in__0\(8)
    );
\read_burst_counter[9]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
...
\read_burst_counter[9]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
\read_burst_counter[9]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
\write_burst_counter[6]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
        ...
        port map (
      I0 => \write_burst_counter[9]_i_3_n_0\,
...
\write_burst_counter[8]_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => \write_burst_counter[9]_i_3_n_0\,
      I2 => \write_burst_counter_reg_n_0_[7]\,
      I3 => \write_burst_counter_reg_n_0_[8]\,
      O => p_0_in(8)
    );
\write_burst_counter[9]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
...
\write_burst_counter[9]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
\write_burst_counter[9]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8000000000000000"
    )
        port map (
      ...
      O => \write_burst_counter[9]_i_3_n_0\
    );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal \^m_axi_awaddr\ : STD_LOGIC_VECTOR ( 31 downto 3 );
...
begin
  ...
  m_axi_awaddr(31 downto 3) <= \^m_axi_awaddr\(31 downto 3);
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_myip_axi_v1_0
     port map (
      ...
      m_axi_aresetn => m_axi_aresetn,
      m_axi_arready => m_axi_arready,
      m_axi_awaddr(28 downto 0) => \^m_axi_awaddr\(31 downto 3),
      m_axi_awready => m_axi_awready,
