...
HD_PWD='F:/Desktop/Vivado_prj/8/axi_test/axi_test.runs/design_1_axi_r_w_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_r_w_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_r_w_0_1.tcl
